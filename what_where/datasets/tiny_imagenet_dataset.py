...
class TinyImageNet(VisionDataset):
    ...
    def __init__(self, root, split='train', transform=None, target_transform=None, download=False, pre_load=True):
        ...
        if self.pre_load:
            print("Loading all images to memory...")
            self.all_images = []
            for i in tqdm(range(len(self.targets))):
                img_path, target = self.data[i]
                self.all_images.append(self.loader(img_path))
